...
Purpose: Used to investigate different ways to pass variables to functions.
Specific explanations are given in comment blocks in main() where each of
the 3 functions are attempted to be called.
-------------------------------------------------------------------------*/
