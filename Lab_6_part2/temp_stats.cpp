...
/*If number of terms is an even number, the median is between terms (n/2) and (n/2)+1
However, our index starts at 0, so the median would actually be between the
terms (n/2)-1 and (n/2). If there is an odd number of terms, the median is simply
the term (n/2)*/
